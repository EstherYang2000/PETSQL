...
python src/sources/sql_gen/call_llm.py \
    ...
    --model claudeaapi \
    --model_version claudea:latest \
    --out_file claudeaapi_3.7.json \
    --dataset_type test \
    --start_num_prompts 541 \
    --end_num_prompts 600 \
    --batch_size 1 \
    --call_mode append \
    --n_samples 1
...
python src/sources/post_process.py \
    --file data/process/PPL_TEST.JSON-9_SHOT_Euclidean_mask_1034/claudeaapi_3.7.json \
    --output data/process/PPL_TEST.JSON-9_SHOT_Euclidean_mask_1034/claudeaapi_3.7_output.json \
    --llm sensechat
python src/sources/extract_sql_output.py \
    --file data/process/PPL_TEST.JSON-9_SHOT_Euclidean_mask_1034/claudeaapi_3.7_output.json \
    --output data/process/PPL_TEST.JSON-9_SHOT_Euclidean_mask_1034/claudeaapi_3.7_output.txt


python src/sources/evaluation.py \
    --gold ./data/spider/test_gold.sql  \
    --pred data/process/PPL_TEST.JSON-9_SHOT_Euclidean_mask_1034/claudeaapi_3.7_output.txt \
    --etype all \
...
python src/sources/schemalink.py --output ppl_test_add_sl.json --dataset_type test --file data/process/PPL_TEST.JSON-9_SHOT_Euclidean_mask_1034/gptapi_o1_output.txt
...
python src/sources/post_process.py \
    --file data/process/PPL_TEST_ADD_SL.JSON-9_SHOT_Euclidean_mask_1034/gptapi_o1.json \
    --output data/process/PPL_TEST_ADD_SL.JSON-9_SHOT_Euclidean_mask_1034/gptapi_o1_output.json \
    --llm sensechat

python src/sources/extract_sql_output.py \
    --file data/process/PPL_TEST_ADD_SL.JSON-9_SHOT_Euclidean_mask_1034/gptapi_o1_output.json \
    --output data/process/PPL_TEST_ADD_SL.JSON-9_SHOT_Euclidean_mask_1034/gptapi_o1_output.txt

python src/sources/evaluation.py \
    --gold ./data/spider/test_gold.sql  \
    --pred data/process/PPL_TEST.JSON-9_SHOT_Euclidean_mask_1034/final_sql_1.txt\
    --etype all \
    --db ./data/spider/test_database \
